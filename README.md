...
### 4. Phân hệ Giao diện Website dashboard (Task 4 - Webserver)
...
## Hướng dẫn sử dụng website dashboard
1. Sau khi nạp code ở bước 4 mục "Hướng dẫn cài đặt (Getting Started), tiến hành kết nối wifi "esp32_myown" với password: 123456789 (có thể chỉnh ở file global.cpp)
2. Truy cập đường link http://192.168.4.1/
3. Sử dụng sidebar để điều hướng sang các trang khác
---
